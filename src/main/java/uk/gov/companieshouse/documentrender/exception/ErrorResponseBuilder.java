...
public class ErrorResponseBuilder {
    ...
    public static ErrorResponseBuilder status(final HttpStatus status) {
    ...
    public ErrorResponseBuilder withError(final ApiError error) {
        this.errors.add(error);
        return this;
    }

    public ErrorResponseBuilder withError(String error, String location, String locationType, String type) {
